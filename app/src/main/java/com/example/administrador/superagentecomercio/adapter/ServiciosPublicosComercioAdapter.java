...
public class ServiciosPublicosComercioAdapter extends BaseAdapter {

    ArrayList<EmpresasServiciosEntity> items;
    Context context;
    LayoutInflater layoutInflater = null;

    public ServiciosPublicosComercioAdapter(ArrayList<EmpresasServiciosEntity> items, Context context) {
        this.items = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.row_servicios_publicos_comercio,null);
    ...
    public void setNewListServiciosPublicosComercio(ArrayList<EmpresasServiciosEntity> listBeneficiario){
